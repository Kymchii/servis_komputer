            ...
            <form action="{{route('admin.keluhan.update', $keluhan->id_keluhan)}}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="id_komputer" id="exampleFormControlSelect1">
                        ...
                        <option value="{{old('id_komputer', $dt_komputer->id_komputer)}}">{{old('merk', $dt_komputer->merk)}}</option>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="id_customer" id="exampleFormControlSelect1">
                        ...
                        <option value="{{old('id_customer', $dt_customers->id_customer)}}">{{old('nama_customer', $dt_customers->nama_customer)}}</option>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="id_pegawai" id="exampleFormControlSelect1">
                        ...
                        <option value="{{old('id_pegawai', $dt_pegawai->id_pegawai)}}">{{old('nama_pegawai', $dt_pegawai->nama_pegawai)}}</option>
