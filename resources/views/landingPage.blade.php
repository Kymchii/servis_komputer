...
<head>
    ...
    <link href={{'build/assets/vendor/simple-line-icons/simple-line-icons.min.css'}} rel="stylesheet" type="text/css" />
    <link href={{'build/assets/vendor/bootstrap/css/bootstrap.min.css'}} rel="stylesheet" type="text/css" />
    <link href={{'build/assets/css/animate.css'}} rel="stylesheet">
    <link href={{'build/assets/vendor/swiper/css/swiper.min.css'}} rel="stylesheet" type="text/css" />
    <link href={{'build/assets/css/layout.min.css'}} rel="stylesheet" type="text/css" />
...
<body id="body" data-spy="scroll" data-target=".header">
                    ...
                    <div class="menu-container">
                        <ul class="nav navbar-nav navbar-nav-right">
                            <li class="js_nav-item nav-item">
                                ...
                                <a class="nav-item-child nav-item-hover" href="{{route('admin.admin.dashboard')}}">Dashboard</a>
                                @elseif (auth()->user()->level == 'Pegawai')
                                <a class="nav-item-child nav-item-hover" href="{{route('pegawai.pegawai.dashboard')}}">Dashboard</a>
                                @else
                                <a class="nav-item-child nav-item-hover" href="{{route('customers.customers.dashboard')}}">Dashboard</a>
                                @endif
                                @else
    ...
    <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
            <div class="item active">
                <img class="img-responsive" src="build/assets/img/1920x1080/01.jpg" alt="Slider Image">
                <div class="container">
            ...
            <div class="item">
                <img class="img-responsive" src="build/assets/img/1920x1080/02.jpg" alt="Slider Image">
                <div class="container">
                    <div class="carousel-centered">
                        <div class="margin-b-40">
        ...
        <div class="content-lg container">
            ...
            <div class="masonry-grid row">
                ...
                <div class="masonry-grid-item col-xs-12 col-sm-6 col-md-4 sm-margin-b-30">
                    ...
                    <img class="full-width img-responsive wow fadeInUp" src="build/assets/img/500x500/01.jpg" alt="Portfolio Image" data-wow-duration=".3" data-wow-delay=".2s">
                </div>
                <div class="masonry-grid-item col-xs-12 col-sm-6 col-md-4">
                    ...
                    <img class="full-width img-responsive wow fadeInUp" src="build/assets/img/500x500/02.jpg" alt="Portfolio Image" data-wow-duration=".3" data-wow-delay=".3s">
                </div>
                <div class="masonry-grid-item col-xs-12 col-sm-6 col-md-4">
                    ...
                    <img class="full-width img-responsive wow fadeInUp" src="build/assets/img/500x500/03.jpg" alt="Portfolio Image" data-wow-duration=".3" data-wow-delay=".4s">
                </div>
            </div>
            <!-- End Masonry Grid -->
        </div>
            ...
            <div class="content-md container">
                ...
                <div class="masonry-grid row">
                    ...
                    <div class="masonry-grid-item col-xs-12 col-sm-6 col-md-4 md-margin-b-30">
                        ...
                        <div class="work work-popup-trigger">
                            <div class="work-overlay">
                                <img class="full-width img-responsive" src="build/assets/img/397x300/01.jpg" alt="Portfolio Image">
                            </div>
                    ...
                    <div class="masonry-grid-item col-xs-12 col-sm-6 col-md-4 md-margin-b-30">
                        ...
                        <div class="work work-popup-trigger">
                            <div class="work-overlay">
                                <img class="full-width img-responsive" src="build/assest/img/397x300/02.jpg" alt="Portfolio Image">
                            </div>
                            <div class="work-popup-overlay">
                                <div class="work-popup-content">
                                    <a href="javascript:void(0);" class="work-popup-close">Hide</a>
                    ...
                    <div class="masonry-grid-item col-xs-12 col-sm-6 col-md-4">
                        ...
                        <div class="work work-popup-trigger">
                            <div class="work-overlay">
                                <img class="full-width img-responsive" src="build/assets/img/397x300/03.jpg" alt="Portfolio Image">
                            </div>
                            <div class="work-popup-overlay">
                                <div class="work-popup-content">
                                    <a href="javascript:void(0);" class="work-popup-close">Hide</a>
                    ...
                    <div class="masonry-grid-item col-xs-12 col-sm-6 col-md-4 margin-b-30">
                        ...
                        <div class="work work-popup-trigger">
                            <div class="work-overlay">
                                <img class="full-width img-responsive" src="build/assets/img/397x415/01.jpg" alt="Portfolio Image">
                            </div>
                            <div class="work-popup-overlay">
                                <div class="work-popup-content">
                                    <a href="javascript:void(0);" class="work-popup-close">Hide</a>
                    ...
                    <div class="masonry-grid-item col-xs-12 col-sm-6 col-md-8 margin-b-30">
                        ...
                        <div class="work work-popup-trigger">
                            <div class="work-overlay">
                                <img class="full-width img-responsive" src="build/assets/img/800x400/01.jpg" alt="Portfolio Image">
                            </div>
                            <div class="work-popup-overlay">
                                <div class="work-popup-content">
                                    <a href="javascript:void(0);" class="work-popup-close">Hide</a>
            ...
            <div class="swiper-slider swiper-clients">
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <img class="swiper-clients-img" src="build/assets/img/clients/01.png" alt="Clients Logo">
                    </div>
                    <div class="swiper-slide">
                        <img class="swiper-clients-img" src="build/assets/img/clients/02.png" alt="Clients Logo">
                    </div>
                    <div class="swiper-slide">
                        <img class="swiper-clients-img" src="build/assets/img/clients/03.png" alt="Clients Logo">
                    </div>
                    <div class="swiper-slide">
                        <img class="swiper-clients-img" src="build/assets/img/clients/04.png" alt="Clients Logo">
                    </div>
                    <div class="swiper-slide">
                        <img class="swiper-clients-img" src="build/assets/img/clients/05.png" alt="Clients Logo">
                    </div>
                    <div class="swiper-slide">
                        <img class="swiper-clients-img" src="build/assets/img/clients/06.png" alt="Clients Logo">
                    </div>
                </div>
                <!-- End Swiper Wrapper -->
            </div>
    ...
    <footer class="footer">
        ...
        <div class="content container">
            <div class="row">
                <div class="col-xs-6">
                    <img class="footer-logo" src="build/assets/img/logo-dark.png" alt="flameonepage Logo">
                </div>
    ...
    <!-- CORE PLUGINS -->
    <script src={{'build/assets/vendor/jquery.min.js'}} type="text/javascript"></script>
    <script src={{'build/assets/vendor/jquery-migrate.min.js'}} type="text/javascript"></script>
    <script src={{'build/assets/vendor/bootstrap/js/bootstrap.min.js'}} type="text/javascript"></script>

    <!-- PAGE LEVEL PLUGINS -->
    <script src={{'build/assets/vendor/jquery.easing.js'}} type="text/javascript"></script>
    <script src={{'build/assets/vendor/jquery.back-to-top.js'}} type="text/javascript"></script>
    <script src={{'build/assets/vendor/jquery.smooth-scroll.js'}} type="text/javascript"></script>
    <script src={{'build/assets/vendor/jquery.wow.min.js'}} type="text/javascript"></script>
    <script src={{'build/assets/vendor/swiper/js/swiper.jquery.min.js'}} type="text/javascript"></script>
    <script src={{'build/assets/vendor/masonry/jquery.masonry.pkgd.min.js'}} type="text/javascript"></script>
    <script src={{'build/assets/vendor/masonry/imagesloaded.pkgd.min.js'}} type="text/javascript"></script>

    <!-- PAGE LEVEL SCRIPTS -->
    <script src={{'build/assets/js/layout.min.js'}} type="text/javascript"></script>
    <script src={{'build/assets/js/components/wow.min.js'}} type="text/javascript"></script>
    <script src={{'build/assets/js/components/swiper.min.js'}} type="text/javascript"></script>
    <script src={{'build/assets/js/components/masonry.min.js'}} type="text/javascript"></script>
